...
import PromemoriaClienti from '../components/dashboard/PromemoriaClienti'
...
const NAV = [
  ...
  { id: 'promemoria-clienti', label: 'Promemoria clienti', icon: IconMessageCircle },
...
export default function Dashboard() {
  ...
  const Section = {
    ...
    'promemoria-clienti': PromemoriaClienti,
    agenda:     Agenda,
    clienti:    Clienti,
  }[section]
    ...
    <div className="db-shell">
      ...
      <div className="db-main">
        ...
        <main className="db-content">
          ...
          {business?.status === 'trial' && !trialExpired && !business?.is_free && (
